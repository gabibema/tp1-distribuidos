...
def main():
    ...
    worker = StatefulFilter(update_state, filter_condition, rabbit_hostname, src_exchange=src_exchange, dst_exchange=dst_exchange, dst_routing_key='top_fiction_books')
    worker.start()
